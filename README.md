<h1 align="center">Hi, I'm Hemarshini 👋</h1>
<h3 align="center">AI/ML Engineer · Generative AI · Data Science & Analytics</h3>

<p align="center">
Turning raw data into insight, and insight into deployed, working products.
</p>
...
I work at the intersection of **data, machine learning, and Generative AI** — comfortable moving between exploratory data analysis and dashboards on one end, and building and deploying multi-modal AI systems (RAG pipelines, LLM-based applications, real-time emotion detection, NLP evaluation frameworks) on the other.

My foundation is in **Python, SQL, Pandas, NumPy, and Scikit-learn** — the same core toolkit whether I'm cleaning and modeling a dataset to answer a business question, building a predictive model, or engineering a retrieval pipeline for an LLM. I design and ship complete, end-to-end work independently: data preprocessing, analysis, model development, evaluation, and deployment — and I validate every result with measurable outcomes, not assumptions.

I care as much about *why* a decision was made as the final number — false-positive tradeoffs, retrieval grounding, query performance, latency constraints, and honest documentation of limitations are things you'll find across my work, not just headline metrics.

I'm currently looking for full-time opportunities as an **AI/ML Engineer, Generative AI Engineer, Data Scientist, or Data Analyst.**
...
`Pandas` `NumPy` `Exploratory Data Analysis` `Statistical Analysis` `Data Cleaning & Preprocessing` `Data Visualization` `Matplotlib` `Seaborn`

**Machine Learning & Deep Learning**
`Scikit-learn` `TensorFlow / Keras` `Model Evaluation` `Feature Engineering` `Predictive Modeling`

**Generative AI & NLP**
`LangChain` `RAG Pipelines` `FAISS` `Sentence Transformers` `LLMs (Llama, TinyLlama)` `TF-IDF` `Prompt Engineering` `NLP Evaluation Frameworks`

**Computer Vision & Multi-modal**
`OpenCV` `CNNs` `Real-time Emotion Detection` `Haar Cascades`
